...
- Segundo lugar en la categoría B del Hackathon Byte Back con **SecureMe**, un simulador de exposición digital.
- Desarrollo de un CRM internacional con permisos por rol y alcance geográfico (Next.js + Supabase).
- Parte del backend de un sistema de gestión hospitalaria (farmacia, facturación, autenticación con JWT/RBAC).
- Sistemas en tiempo real con Redis Streams, Pub/Sub y Server-Sent Events, en un proyecto de monitoreo IoT.
...
La serpiente de abajo se "come" mis contribuciones del último año — se actualiza sola todos los días:
